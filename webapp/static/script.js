...
async function requestItinerary(citta, giorni) {
    try {
        const response = await fetch("https://ciuegozk9h.execute-api.us-east-1.amazonaws.com/prod/richiesta-itinerario", {
            method: "POST",
            headers: {
        ...
        const intervalId = setInterval(async () => {
            try {
                const resultResponse = await fetch(`https://ciuegozk9h.execute-api.us-east-1.amazonaws.com/prod/risultato-itinerario?requestId=${requestId}`);
...
async function updateDatabase(citta) {
    try {
        const res = await fetch("https://ciuegozk9h.execute-api.us-east-1.amazonaws.com/prod/classifica", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
